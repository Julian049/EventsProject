const API_URL = "http://localhost:3250/category";
        ...
        card.innerHTML = `
            <div class="card-content">
                ...
                <div class="card-actions">
                    <button class="btn-edit" onclick="openEditModal(${category.id}, '${category.name}', '${category.description || ''}')">✏️ Editar</button>
                    <button class="btn-disable" onclick="disableCategory(${category.id})">🚫 Deshabilitar</button>
                </div>
            </div>
        `;
