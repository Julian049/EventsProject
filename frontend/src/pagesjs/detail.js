...
function renderDetail(event) {
    ...
    <div class="detalle-card">
      ...
      <div class="detalle-info">
        ...
        <div class="action-buttons">
          ...
          <button class="btn-disable" id="btn-disable">Deshabilitar</button>
          <button class="btn-interest" id="btn-interest">Me interesa</button>
        </div>
      </div>
    </div>
  ...
  document.getElementById('btn-disable').addEventListener('click', disableEvent)
  document.getElementById('btn-interest').addEventListener('click', clickInterest)
  document.getElementById('btn-cancel').addEventListener('click', closeModal)
  document.getElementById('btn-save').addEventListener('click', saveEvent)
  document.getElementById('modal').addEventListener('click', closeModalOutside)
}
...
async function saveEvent() {
  ...
  try {
    const res = await fetch(`${API_BASE}/event/update/${id}`, {
      method: 'PUT',
...
async function disableEvent() {
  ...
  try {
    await fetch(`${API_BASE}/event/disable/${id}`, { method: 'PATCH' })
...
async function clickInterest() {
  try {
    await fetch(`${API_BASE}/event/interested/${id}`, { method: 'PATCH' })
